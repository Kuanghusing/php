    ...
    <form method="post" action="index.php">
        <table cellpadding="10px">
            ...
            <tr>
                ...
                <td class="td_input"><input type="text" id="email" name="email" placeholder="xxx@xx.xx" required value="<?php echo $_POST['email']?>"/></td>
                <td><span class="error"><?php echo isset($login->errors['email'])?$login->errors['email']:"" ?></span></td>
            </tr>
            <tr>
                <td class="td_title"><label>Password</label></td>
                <td class="td_input"><input type="password" id="password" name="password" required></td>
                <td><span class="error"><?php echo isset($login->errors['pwd'])?$login->errors['pwd']:"" ?></span></td>
            </tr>
            <tr>
                ...
                <td><span class="error"><?php echo isset($login->errors['captcha'])?$login->errors['captcha']:"" ?></span></td>
            </tr>

            <tr><td></td><td colspan="2"> <input type="checkbox" name="remember_me" id="remember_me"><label for="remember_me">Remember me for a week</label></td> </tr>

        </table>
        <div style="width: 50%;margin: 0 auto;">
            <input type="submit" value="Login" name="login" id="login">

            <button class="button" id="register"><a href="" style="text-decoration: none;">Register</a></button>
        </div>
    </form>
</div>
</body>
